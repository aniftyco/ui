...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description ref={ref} className={cx('text-sm text-muted-foreground', className)} {...props} />
));
...
>(({ className, ...props }, ref) => <AlertDialogPrimitive.Action ref={ref} className={cx(className)} {...props} />);
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel ref={ref} className={cx('mt-2 sm:mt-0', className)} {...props} />
));
